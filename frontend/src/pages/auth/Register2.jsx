...
import { User, Mail, Lock, ArrowRight, ShoppingBag, CheckCircle } from "lucide-react";
      ...
      >
        ...
        <div className="relative hidden md:block h-full min-h-[600px] bg-linear-to-br from-purple-900 to-purple-700">
          ...
          <div className="absolute bottom-8 left-8 right-8">
            ...
            <p className="text-white/60 text-sm mt-2">
              Get exclusive access to limited drops and member-only pricing.
            </p>
            ...
            <div className="mt-6 space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/80 text-sm">Free shipping on all orders</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="w-5 h-5 text-white/80" />
                <span className="text-white/80 text-sm">Early access to new releases</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="w-5 h-5 text-white/80" />
                <span className="text-white/80 text-sm">30-day return policy</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 sm:p-10 md:p-12 lg:p-16 flex flex-col justify-center bg-white">
          ...
          <div className="md:hidden flex flex-col items-center gap-2 mb-8">
            ...
            <h1 className="font-bold text-3xl text-purple-800">Join Foothub</h1>
          ...
          <div className="hidden md:block mb-8">
            ...
            <p className="text-gray-500 text-base">
              Join Foothub and start your sneaker journey
            </p>
          </div>
          ...
          {/* Social signup - matches login page */}
          <div className="mt-8">
            <div className="relative">
